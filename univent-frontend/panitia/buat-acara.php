  ...
  <main id="panitia-main" class="p-6 transition-all duration-300">
    ...
    <section class="max-w-3xl mx-auto space-y-6">
      <div>
        ...
        <p class="text-sm text-gray-500">Isi detail acara dengan lengkap</p>
      </div>
      ...
      <div class="bg-white rounded-xl shadow p-6 space-y-6">
        ...
        <div>
          ...
          <input type="file"
            class="w-full border rounded-lg px-4 py-2 file:bg-[#2B77D1] file:text-white file:px-4 file:py-2 file:rounded-lg file:hover:bg-[#2566B8]">
        </div>
        ...
        <div>
          ...
          <textarea
            class="w-full border rounded-lg px-4 py-3 h-32 focus:ring-2 focus:ring-[#2B77D1] outline-none"
            placeholder="Tuliskan deskripsi acara..."></textarea>
        </div>
